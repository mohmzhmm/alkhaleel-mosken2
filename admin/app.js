...
function updateLayoutPreviewSource(){const frame=$('layout-preview'),screenKey=selectedLayoutKey(),next=screenKey==='alkhaleel-mosken2'?'../index.html?adminPreview=20260923-2':'/alkhaleel-mosken/?adminPreview=20260923-2';if(frame.getAttribute('src')!==next)frame.src=next}
